...
public class MitadGSActivity extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.activity_mitad_gs, null));
        builder.setPositiveButton("Terminar", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int id) {
                dialogListen.onDialogPositiveClick(MitadGSActivity.this);
            }
        });
        builder.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                MitadGSActivity.this.getDialog().dismiss();
            }
        });
