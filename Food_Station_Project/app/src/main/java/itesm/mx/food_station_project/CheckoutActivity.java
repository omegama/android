...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        payBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fullOrderMail.matches("")){
                    ...
                    if(pp==null){
                        pp = PayPal.initWithAppID(CheckoutActivity.this, "APP-80W284485P519543T", PayPal.ENV_SANDBOX);
                        pp.setLanguage("es_MX");
                        pp.setLibraryInitialized(true);
                    }
                    PayPalPayment payment = new PayPalPayment();
                    payment.setCurrencyType("MXN");
                    payment.setRecipient("omegama-facilitator@outlook.com");
                    payment.setSubtotal(new BigDecimal(ordenTotal));
                    payment.setPaymentType(PayPal.PAYMENT_TYPE_GOODS);
                    PayPalInvoiceData invoice = new PayPalInvoiceData();
                    payment.setMerchantName("FoodStation");
                    invoice.setTax(new BigDecimal(0));

                    Intent paypalIntent = PayPal.getInstance().checkout(payment, CheckoutActivity.this);
                    CheckoutActivity.this.startActivityForResult(paypalIntent, 1);

                    final String msg = fullOrderMail + "\nTotal pagado: $" + ordenTotal.toString();
        ...
        Button orderBtn = (Button)findViewById(R.id.buttonOrder);
